...
public class TestProgram {
    ...
    public static void test10_LatestActivity() {
        ...
        Iterator<Event> latestEvents = helpDesk.getLatestActivity().iterator();

//        Event event = latestEvents.next();
//        Event event2 = latestEvents.next();
//        Event event3 = latestEvents.next();
//        Event event4 = latestEvents.next();
//        Event event5 = latestEvents.next();

        assertEqual(latestEvents.next().toString(), "Event: Created ticket. [CREATED] (11/3/21 14:12)", "Should be 'Event: Created ticket. [CREATED] (11/3/21 14:12)'");
        assertEqual(latestEvents.next().toString(), "Event: Assigned to Technician A17440, Caelem. [ASSIGNED] (11/3/21 14:12)", "Should be 'Event: Assigned to Technician A17440, Caelem. [ASSIGNED] (11/3/21 14:12)'");
        assertEqual(latestEvents.next().toString(), "Event: Created ticket. [CREATED] (11/3/21 14:01)", "Should be 'Event: Created ticket. [CREATED] (11/3/21 14:01)'");
        assertEqual(latestEvents.next().toString(), "Event: Assigned to Technician A05589, Andree. [ASSIGNED] (11/3/21 14:01)", "Should be 'Event: Assigned to Technician A05589, Andree. [ASSIGNED] (11/3/21 14:01)'");
        assertEqual(latestEvents.next().toString(), "Event: Found user's ME2020 Maven cache way overloaded, recommended cleaning it out. [RESOLVED] (11/3/21 13:19)", "Should be 'Event: Found user's ME2020 Maven cache way overloaded, recommended cleaning it out. [RESOLVED] (11/3/21 13:19)'");
